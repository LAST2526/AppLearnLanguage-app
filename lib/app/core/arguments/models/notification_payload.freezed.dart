...
mixin _$NotificationPayload {
  ...
  bool get canInterest => throw _privateConstructorUsedError;
    ...
    return _then(_value.copyWith(
      ...
      body: null == body
          ...
          : body // ignore: cast_nullable_to_non_nullable
              as String,
      canInterest: null == canInterest
          ? _value.canInterest
          : canInterest // ignore: cast_nullable_to_non_nullable
              as bool,
      userId: null == userId
          ? _value.userId
...
class _$NotificationPayloadImpl implements _NotificationPayload {
  ...
  @override
  String toString() {
    return 'NotificationPayload(title: $title, body: $body, canInterest: $canInterest, userId: $userId, notificationId: $notificationId, documentId: $documentId)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.canInterest, canInterest) ||
                other.canInterest == canInterest) &&
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, title, body, canInterest, userId,
...
abstract class _NotificationPayload implements NotificationPayload {
  const factory _NotificationPayload(
      ...
      required final bool canInterest,
      required final int userId,
      required final int notificationId,
      required final String documentId}) = _$NotificationPayloadImpl;
