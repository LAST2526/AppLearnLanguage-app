...
abstract class $UpdateProfileRequestCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {String name, int gender, String dob, String nationality, int courseId});
}
...
class _$UpdateProfileRequestImpl implements _UpdateProfileRequest {
  ...
  @override
  String toString() {
    return 'UpdateProfileRequest(name: $name, gender: $gender, dob: $dob, nationality: $nationality, courseId: $courseId)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, name, gender, dob, nationality, courseId);
...
abstract class _UpdateProfileRequest implements UpdateProfileRequest {
  const factory _UpdateProfileRequest(
      ...
      required final int courseId}) = _$UpdateProfileRequestImpl;
